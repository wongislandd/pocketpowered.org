...
Source: Hexicon main `cafd062`, Godot 4.7.2, 390 × 844. Curated valid late-region fixture with isolated save, normal animation speed, five relics, two items, 50 gold and Ember on P. The full native cast is recorded; no interface, scoring effect, or damage value was fabricated. Complete run progression is not shown.

- `phoenix-cast.mp4`: 12.23-second silent web loop, 30 fps, H.264, 844,879 bytes.
- `phoenix-cast.gif`: sharing/download version, 15 fps, 1,721,962 bytes.
